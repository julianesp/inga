    ...
    return (
        <>
            ...
            {isOpen && (
                ...
                >
                    <div
                        className={`bg-white dark:bg-gray-800 rounded-lg max-w-md w-full p-6 shadow-xl relative z-50 transform transition-all duration-300 ${isAnimating
                    ...
                    >
                        ...
                        <div className="text-center">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3">
                                <button
                                    onClick={closeModal}
                                    className="flex-1 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 py-2 px-4 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-all duration-200 hover:scale-105 active:scale-95"
                                >
                                    Entendido
                                </button>
                                <button
